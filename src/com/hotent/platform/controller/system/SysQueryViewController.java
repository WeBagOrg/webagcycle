...
public class SysQueryViewController extends BaseController
{
	...
	{	
		...
		ModelAndView mv=this.getAutoView()
				.addObject("sysQueryViewList",list)
				.addObject("querySqlDef", querySqlDef)
				.addObject("sqlId", sqlId);
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception
	{
		...
		return this.getAutoView().addObject("templates", templates)
							...
							.addObject("commonVars", JSONArray.fromObject(CommonVar.getCurrentVars(false)))
	...
	public ModelAndView editTemplate(HttpServletRequest request) throws Exception
	{
		...
		return this.getAutoView()
				.addObject("sysQueryView", sysQueryView)
				.addObject("historyDatas", historyDatas);
	}
	/**
	 * 取得视图定义明细
	 * @param request   
	...
	public void saveExports(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		HSSFWorkbook	workbook=sysQueryViewService.genExcel(currentPage, pageSize, queryParams, 
				sysQueryView, sortField, orderSeq, exportNames);
