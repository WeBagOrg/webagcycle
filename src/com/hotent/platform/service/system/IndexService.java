...
import com.hotent.platform.model.index.IndexTab;
import com.hotent.platform.model.index.IndexTabList;
...
public class IndexService {
	...
	public List<Infobox> getInfobox() {
		...
		try {
			...
			infobox13.setUrl("/platform/bpm/bpmProCopyto/myList.ht");
			list.add(infobox13);
