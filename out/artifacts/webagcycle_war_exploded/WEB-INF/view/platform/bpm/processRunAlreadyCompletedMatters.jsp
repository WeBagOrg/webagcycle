...
<html>
    <head>
        ...
        <script type="text/javascript">
    			var catKey="<%=GlobalType.CAT_FLOW%>";
     			var glTypeTreeUrl = __ctx+'/platform/system/globalType/getByCatKeyForBpmAlreadyCompleted.ht',
     			leftClickUrl= __ctx+'/platform/bpm/processRun/alreadyCompletedMattersList.ht'
         </script> 
    ...
    <body>
      	<div id="defLayout" >
            ...
            <div position="center">
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/processRun/alreadyCompletedMattersList.ht"></iframe>
            </div>
        </div>
    </body>
</html>
