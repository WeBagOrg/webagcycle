...
public class SubSystemService extends BaseService<SubSystem>
{
	 ...
	 * @throws Exception
	 */
	public String exportXml(long systemId)throws Exception
	{
		...
		List<Resources> resources=resourcesDao.getBySystemId(systemId);
	...
	public void importXml(InputStream inputStream)throws Exception
	{
		...
		{
			// 导入表，并解析相关信息
			this.importResourcesXml(pesourcesXml);
		}
	}
	/**
	 * 导入时生成子系统资源
	 ...
	 * @throws Exception 
	 */
	private void importResourcesXml(ResourcesXml pesourcesXml) throws Exception 
	{
