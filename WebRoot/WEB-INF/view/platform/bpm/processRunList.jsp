...
<body>
			<div class="panel">
				...
				<div class="panel-body">
					    ...
					    <display:table name="processRunList" id="processRunItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid except" export="true" >
							...
							<display:column title="流程定义名称" sortable="true" sortName="processName" style="text-align:left">
								<a onclick="showDetail(this)" href="#${processRunItem.runId}"  action="${ctx }/platform/bpm/processRun/info.ht?link=1&runId=${processRunItem.runId}" title='${processRunItem.processName}' >${processRunItem.processName}</a>
							</display:column>
