...
<script type="text/javascript">
	...
	function ExportXml(){
		...
		ImportExportXml.showModalDialog({url:url,title:'导出自定义表'});
					...
					<c:choose>
						<c:when test="${bpmFormTableItem.isExternal == 0 }">
							<c:if test="${bpmFormTableItem.genByForm==0}">
								...
								<a href="javascript:;" prehref="reset.ht?tableId=${bpmFormTableItem.tableId}" name="reset" class="link reset" >重置</a>
