				...
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="l-bar-separator"></div>
							<div class="group"><a class="link back" onclick="history.back(-1);" id="back"><span></span>返回</a></div>
						</div>
					</div>
				</div>
			</div>
						...
						<div >
							...
							<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main" style="border-width: 0!important;">
								<tr>
									<th  width="10%">名称:</th>
									<td>
										<input type="text" class="hidden" id="sn" ng-model="dataRightsJson.sn"/>
										<input type="text" ng-model="dataRightsJson.name"   class="ht-input" validate="{required:true}" style="width:210px;margin-right:2px;" 
											ng-blur="service.setPingyin(this,'dataRightsJson.name','dataRightsJson.alias')" />
									</td>
								</tr>
								<tr>
									<th  width="10%">别名:</th>
								...
								<tr>
									<th >是否分页:</th>
									<td>
										<input ng-model="dataRightsJson.needPage" type="checkbox"  ng-true-value=1 ng-false-value=0 ng-checked="dataRightsJson.needPage == 1" />
								...
								<tr>
									<th>是否初始查询:</th>
									<td>
										<input ng-model="dataRightsJson.initQuery" type="checkbox" ng-true-value=1 ng-false-value=0 ng-checked="dataRightsJson.initQuery == 1" />
								...
								<tr>
									<th>是否显示行号:</th>
									<td>
										<input ng-model="dataRightsJson.showRowsNum" type="checkbox" ng-true-value=1 ng-false-value=0 ng-checked="dataRightsJson.showRowsNum == 1" />
									...
									<tr style="height: 50px;">
										...
										<td colspan="4" style="text-align: left; width: 100%;">
											<div style="float: left;"> 
												<input ng-model="dataRightsJson.supportGroup" ng-checked="dataRightsJson.supportGroup==1" type="checkbox" ng-true-value=1 ng-false-value=0 />
											</div>
													...
													<table class="table-grid" ng-if="groupingView.length>0">
														...
														<tbody>
															<tr  ng-repeat="f in groupingView track by $index">
																...
																<td >{{f.groupField}}</td>
																<td >
																	<input ng-model="f.groupSummary" ng-if="f.groupSummary==1"  type="checkbox" ng-true-value=1 ng-false-value=0 ng-checked="f.groupSummary==1"/>
																</td>
																<td >
																	<input ng-model="f.groupColumnShow" type="checkbox" ng-true-value=1 ng-false-value=0 ng-checked="f.groupColumnShow==1"/>
																</td>
																<td >
																...
																<td >
																	<textarea rows="5" ng-model="f.groupText" ng-blur="f.txtChange = true" style="padding: 15px 0 0 0px;resize: none" class="w100  border-none margin-none "></textarea>
																</td>
																<td>
