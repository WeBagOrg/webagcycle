...
<style type="text/css" media="print">
	@media print {
		...
		.printForm{display:block !important;width: 100%;} 
		.panel-detail {
			width: 100% !important;
		}
	}
							    ...
							    <td height="111" valign="middle" width="480" background="/ecp/styles/default/images/warm.gif">
								    <table height="89" width="449" border="0" cellpadding="0" cellspacing="0">
								      <tbody>
									      ...
									      <tr>
									        <td height="30" valign="top"><span class="STYLE1">该流程表单尚未添加打印模版，是否使用默认打印模版？<a href="javascript:;" onclick="reloadUseDefaultForm(this)">【确定】</a></span></td>
