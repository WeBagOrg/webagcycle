			...
			<div  id="tabMyInfo" class="panel-nav" style="overflow:hidden; position:relative;">  
	           <div title="基本信息" tabid="linkmandetail" icon="${ctx}/styles/default/images/resicon/user.gif">
			           		<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
								...
								<tr>
								    <th>电   话: </th>
									<td ><input type="text" id="phone" name="phone" value="${oaLinkman.phone}"  style="width:240px !important" class="inputText"/></td>
								</tr>
								<tr>
								   <th>邮箱地址: </th>
								   <td ><input type="text" id="email" name="email" value="${oaLinkman.email}" style="width:240px !important" class="inputText"/></td>
								</tr>
								<tr>
								   <th>公司: </th>
