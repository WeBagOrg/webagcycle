...
public class DictionaryService extends BaseService<Dictionary>
{
	...
	public Map<String, String> getMapByNodeKey(String nodekey) {
		// TODO Auto-generated method stub
		List<Dictionary>  list=this.getByNodeKey(nodekey);
		Map<String,String> orgChiefMap=new HashMap<String,String>();
		for(int i=0;i<list.size();i++)
		{
			orgChiefMap.put(list.get(i).getItemName(), list.get(i).getItemValue());
		}
		return orgChiefMap;
