	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group"><a class="link del" id="dataFormSave" onclick="del()" href="#"><span></span>删除</a></div>
			</div>
		</div>
	</div>
			...
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0" type="main">
				...
				<tr>
					...
					<select id="action" name="action">
						...
						<option value="reject" <c:if test="${bpmNewFlowTrigger.action eq 'reject'}">selected="selected"</c:if>>驳回</option>
