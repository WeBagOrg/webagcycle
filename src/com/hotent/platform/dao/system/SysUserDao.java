...
public class SysUserDao extends BaseDao<SysUser> implements UserDetailsService {
	...
	public void updPwd(Long userId, String pwd) {
		...
		map.put("pwdUpdTime", new Date());//更新密码时期
	...
	public void updateCommon(SysUser sysUser) {
		this.update("updateCommon", sysUser);
	}
	
	//ipph add 2015-10-15
	public List<SysUser> getByIds(List<Long> ids)
	{
	    return getBySqlKey("getByIds", ids);
	}

	public void lockIt(Long userId) {
		 update("lockIt", userId);
	}

	public SysUser getByUserName(String username) {
		// TODO Auto-generated method stub
		return this.getUnique("getByUserName", username);
	}
