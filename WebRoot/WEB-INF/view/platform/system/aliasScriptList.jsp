...
<script type="text/javascript">
	...
	function exportXml(){	
		...
		var url=__ctx + "/platform/system/aliasScript/exportXml.ht?tableIds="+tableIds;
		if (tableIds  ==''){
	...
	//导入别名脚本
	function importXml(){
		var url=__ctx + "/platform/system/aliasScript/import.ht";
		ImportExportXml.showModalDialog({url:url,title:'导入别名脚本'});
	}	 
