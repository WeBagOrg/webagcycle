...
<title>安装程序</title>
<link href="<%=ctx %>/install/css/install.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<%=ctx %>/install/js/jquery.js"></script>
...
<body>
	<div class="header">
		<div class="title">安装程序 - 许可协议</div>
		<div class="banner"></div>
	</div>
	<div class="body">
		<form id="inputForm" action="<%=ctx %>/install/check.jsp" method="get">
			<div class="bodyLeft">
				<ul class="step">
			...
			<div class="bodyRight">
				<iframe scrolling="yes" src="<%=ctx %>/install/license.html"></iframe>
