...
<body>
	<div class="panel">
		...
		<div class="status">当前状态 ：已计算   &nbsp;&nbsp;<!-- <f:attenceType val="${calculate.attenceType}"></f:attenceType>  --></div>
		...
		<c:choose>
			<c:when test="${empty  calculate}">
				<div class="smallTitle">
					<span class="spanRight">无排班记录</span>
			...
			<c:when test="${calculate.isCardRecord == 1 }">
				...
				<div class="smallTitle1">
						...
						<span class="spanLeft">${calculate.validCardRecord}</span>
				</div>
			</c:when>
			<c:otherwise>
				<div class="smallTitle">
		...
		<c:choose>
			<c:when test="${calculate.absentNumber > 0 }">
				...
				<div class="smallTitle1">
					...
					<span class="spanLeft">${calculate.shiftTime11}</span>
				</div>
				<div class="smallTitle1">
					<span class="spanRight">${calculate.shiftTime21}</span>
					<span class="spanLeft">${calculate.shiftTime31}</span>
				</div>
				<div class="smallTitle1">
					<span class="spanRight">实际出勤时间</span>
					<span class="spanLeft">${calculate.absentRecord11}</span>
				</div>
				<div class="smallTitle1">
					<span class="spanRight">${calculate.absentRecord21}</span>
					<span class="spanLeft">${calculate.absentRecord31}</span>
				</div>
			</c:when>
			<c:otherwise>
		...
		<div class="bigTitle"><span>加班情况</span></div>
		<c:choose>
			<c:when test="${calculate.otNumber > 0 }">
				<div class="smallTitle1">
					<span class="spanRight">加班次数</span>
					<span class="spanLeft">${calculate.otNumber}</span>
				</div>
				<div class="smallTitle1">
					<span class="spanRight">加班分钟</span>
					<span class="spanLeft">${calculate.otTime}</span>
				</div>
			</c:when>
			<c:otherwise>
				<div class="smallTitle1" ><span class="spanRight">无</span><span class="spanLeft"></span></div>
			...
			<div class="bigTitle"><span>请假情况</span></div>
		<c:choose>
			<c:when test="${calculate.holidayNumber > 0 }">
				<div class="smallTitle1">
					<span class="spanRight">请假次数</span>
					<span class="spanLeft">${calculate.holidayNumber}</span>
				</div>
				<div class="smallTitle1">
					<span class="spanRight">请假时间（天）</span>
					<span class="spanLeft">${calculate.holidayTime}</span>
				</div>
			</c:when>
			<c:otherwise>
				<div class="smallTitle1" ><span class="spanRight">无</span><span class="spanLeft"></span></div>
		...
		<div class="bigTitle"><span>出差情况</span></div>
		<c:choose>
			<c:when test="${calculate.tripNumber > 0 }">
				<div class="smallTitle1">
					<span class="spanRight">出差次数</span>
					<span class="spanLeft">${calculate.tripNumber}</span>
				</div>
				<div class="smallTitle1">
					<span class="spanRight">出差分钟</span>
					<span class="spanLeft">${calculate.tripTime}</span>
				</div>
			</c:when>
			<c:otherwise>
				<div class="smallTitle1" ><span class="spanRight">无</span><span class="spanLeft"></span></div>
