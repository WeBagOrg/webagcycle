...
public class TriggerNewFlowEventListener implements ApplicationListener<TriggerNewFlowEvent>, Ordered {
	...
	public void onApplicationEvent(TriggerNewFlowEvent event) {
		...
		TriggerNewFlow triggerNewFlow = AppUtil.getBean(TriggerNewFlow.class);
		try {
			...
			String fromDataStr = formHandlerService.getBpmFormDataJson((ProcessRun)fromCmd.getProcessRun(), fromCmd.getBusinessKey(), nodeId);
