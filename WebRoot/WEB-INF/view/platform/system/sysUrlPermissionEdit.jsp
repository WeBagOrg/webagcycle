			...
			<form id="sysUrlPermissionItems" method="post" action="save.ht">
				...
				<table class="table-detail" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td><input type="text" id="descp" name="descp" size="50"
							value="${sysUrlPermission.descp}" validate="{required:true}" /></td>
					</tr>
					<tr>
					...
					<tr>
						<th width="20%">参数名称:</th>
						<td>
							<input type="text" name="params" id="params" value="${sysUrlPermission.params}"  size="100">
