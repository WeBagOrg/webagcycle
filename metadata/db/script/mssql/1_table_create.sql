...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '密码更新时间',
   'user', @CURRENTUSER, 'table', 'SYS_USER', 'column', 'PWDUPDTIME'
go
...
CREATE TABLE SYS_QUERY_SQLDEF (
   ...
   SQL_                 VARCHAR(2000)        NULL,
   DSNAME               VARCHAR(50)          NULL,
   BUTTON_DEF           VARCHAR(1000)        NULL,
   ALIAS                VARCHAR(50)          NULL,
   CATEGORYID           NUMERIC(18,0)        NULL,
   SUPPORT_TAB          SMALLINT             NULL,
   CONSTRAINT PK_SYS_QUERY_SQLDEF PRIMARY KEY NONCLUSTERED (ID)
)
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_SQLDEF', 'column', 'ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '名称',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_SQLDEF', 'column', 'NAME'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'SQL定义',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_SQLDEF', 'column', 'SQL_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '数据源名称',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_SQLDEF', 'column', 'DSNAME'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '按纽定义',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_SQLDEF', 'column', 'BUTTON_DEF'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '别名',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_SQLDEF', 'column', 'ALIAS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '分类ID',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_SQLDEF', 'column', 'CATEGORYID'
go


CREATE TABLE SYS_QUERY_VIEW (
   ID                   NUMERIC(18,0)        NOT NULL,
   SQL_ALIAS            VARCHAR(50)          NULL,
   NAME                 VARCHAR(50)          NULL,
   ALIAS                VARCHAR(50)          NULL,
   ...
   INIT_QUERY           SMALLINT             NULL,
   TEMPLATE             TEXT                 NULL,
   SUPPORT_GROUP        SMALLINT             NULL,
   GROUP_SETTING        VARCHAR(400)         NULL,
   PAGE_SIZE            SMALLINT             NULL,
   SHOW_ROWS_NUM        SMALLINT             NULL,
   SN                   NUMERIC(18,0)        NULL,
   NEED_PAGE            SMALLINT             NULL,
   TEMPLATEALIAS        VARCHAR(50)          NULL,
   CONSTRAINT PK_SYS_QUERY_VIEW PRIMARY KEY NONCLUSTERED (ID)
)
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'sql别名',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'SQL_ALIAS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '视图名称',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'NAME'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '视图别名',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'ALIAS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '查询条件定义',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'CONDITIONS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '过滤器类型',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'FILTER_TYPE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '过滤器',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'FILTER'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '按纽定义',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'BUTTONS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否初始化查询',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'INIT_QUERY'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '模版定义',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'TEMPLATE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否支持分组',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'SUPPORT_GROUP'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '分组设定',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'GROUP_SETTING'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '分页大小',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'PAGE_SIZE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '显示行号',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'SHOW_ROWS_NUM'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '排序',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'SN'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否分页',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'NEED_PAGE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '摸版别名',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_VIEW', 'column', 'TEMPLATEALIAS'
go
CREATE TABLE SYS_QUERY_METAFIELD (
   ...
   IS_SEARCH            SMALLINT             NULL,
   CONTROL_TYPE         SMALLINT             NULL,
   DATA_TYPE            VARCHAR(10)          NULL,
   IS_VIRTUAL           SMALLINT             NULL,
   VIRTUAL_FROM         SMALLINT             NULL,
   RESULT_FROM_TYPE     VARCHAR(10)          NULL,
   RESULT_FROM          VARCHAR(400)         NULL,
   ALARM_SETTING        VARCHAR(400)         NULL,
   DATE_FORMAT          VARCHAR(40)          NULL,
   URL                  VARCHAR(200)         NULL,
   FORMATER             VARCHAR(1000)        NULL,
   CONTROL_CONTENT      VARCHAR(400)         NULL,
   CONSTRAINT PK_SYS_QUERY_METAFIELD PRIMARY KEY NONCLUSTERED (ID)
)
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'SQL_ID',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'SQL_ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '字段名',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'NAME'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '实际字段名',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'FIELD_NAME'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '字段备注',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'FIELD_DESC'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否可见',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'IS_SHOW'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否搜索',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'IS_SEARCH'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '控件类型',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'CONTROL_TYPE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '数据类型',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'DATA_TYPE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否衍生列',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'IS_VIRTUAL'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '衍生列来自列',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'VIRTUAL_FROM'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '来自类型',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'RESULT_FROM_TYPE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '衍生列配置',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'RESULT_FROM'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '报警设定',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'ALARM_SETTING'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '日期格式',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'DATE_FORMAT'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '连接地址',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'URL'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '格式化函数',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'FORMATER'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '控件内容',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_METAFIELD', 'column', 'CONTROL_CONTENT'
go
CREATE TABLE SYS_QUERY_FIELDSETTING (
   ID                   NUMERIC(18,0)        NOT NULL,
   VIEW_ID              NUMERIC(18,0)        NULL,
   FIELD_NAME           VARCHAR(50)          NULL,
   SORT_ABLE            SMALLINT             NULL,
   DEFAULT_SORT         SMALLINT             NULL,
   SORT_SEQ             VARCHAR(10)          NULL,
   ALIGN                VARCHAR(10)          NULL,
   FROZEN               SMALLINT             NULL,
   SUMMARY_TYPE         VARCHAR(50)          NULL,
   SUMMARY_TEMPLATE     VARCHAR(200)         NULL,
   HIDDEN               SMALLINT             NULL,
   CONSTRAINT PK_SYS_QUERY_FIELDSETTING PRIMARY KEY NONCLUSTERED (ID)
)
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '视图ID',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'VIEW_ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '字段名称',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'FIELD_NAME'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '允许排序',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'SORT_ABLE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '默认排序',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'DEFAULT_SORT'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '默认排序方向',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'SORT_SEQ'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '对齐方式',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'ALIGN'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否冻结',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'FROZEN'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '计算类型',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'SUMMARY_TYPE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '计算模版',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'SUMMARY_TEMPLATE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '是否隐藏',
   'user', @CURRENTUSER, 'table', 'SYS_QUERY_FIELDSETTING', 'column', 'HIDDEN'
go
...
CREATE TABLE SYS_HISTORY_DATA (
   ...
   SUBJECT              VARCHAR(200)         NULL,
   CREATETIME           DATETIME             NULL,
   CONSTRAINT PK_SYS_HISTORY_DATA PRIMARY KEY NONCLUSTERED (ID)
)
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'SYS_HISTORY_DATA', 'column', 'ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '数据类型',
   'user', @CURRENTUSER, 'table', 'SYS_HISTORY_DATA', 'column', 'TYPE_'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '关联对象ID',
   'user', @CURRENTUSER, 'table', 'SYS_HISTORY_DATA', 'column', 'OBJ_ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '存储内容',
   'user', @CURRENTUSER, 'table', 'SYS_HISTORY_DATA', 'column', 'CONTENT'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建人',
   'user', @CURRENTUSER, 'table', 'SYS_HISTORY_DATA', 'column', 'CREATOR'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '创建时间',
   'user', @CURRENTUSER, 'table', 'SYS_HISTORY_DATA', 'column', 'CREATETIME'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '主键',
   'user', @CURRENTUSER, 'table', 'SYS_BULLETIN_TEMPLATE', 'column', 'ID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '名称',
   'user', @CURRENTUSER, 'table', 'SYS_BULLETIN_TEMPLATE', 'column', 'NAME'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '别名',
   'user', @CURRENTUSER, 'table', 'SYS_BULLETIN_TEMPLATE', 'column', 'ALIAS'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   'html内容',
   'user', @CURRENTUSER, 'table', 'SYS_BULLETIN_TEMPLATE', 'column', 'TEMPLATE'
go
...
CREATE TABLE SYS_READ_RECORD (
   ...
   USERID               INT                  NOT NULL,
   CREATETIME           DATETIME             NOT NULL,
   CONSTRAINT PK_SYS_READ_RECORD PRIMARY KEY NONCLUSTERED (ID)
)
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '来源；eg:公告：BULLETINID',
   'user', @CURRENTUSER, 'table', 'SYS_READ_RECORD', 'column', 'SOURCE'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   ...
   'user', @CURRENTUSER, 'table', 'SYS_READ_RECORD', 'column', 'GROUPID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '对象ID',
   'user', @CURRENTUSER, 'table', 'SYS_READ_RECORD', 'column', 'OBJECTID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '用户ID',
   'user', @CURRENTUSER, 'table', 'SYS_READ_RECORD', 'column', 'USERID'
go
...
EXECUTE SP_ADDEXTENDEDPROPERTY 'MS_Description', 
   '阅读时间',
   'user', @CURRENTUSER, 'table', 'SYS_READ_RECORD', 'column', 'CREATETIME'
go

CREATE TABLE SYS_PWD_STRATEGY (
   ID                   INT                  NOT NULL DEFAULT 0,
   INIT_PWD             VARCHAR(50)          NULL DEFAULT NULL,
   FORCE_CHANGE_INIT_PWD SMALLINT             NULL DEFAULT NULL,
   PWD_RULE             SMALLINT             NULL DEFAULT NULL,
   PWD_LENGTH           SMALLINT             NULL DEFAULT NULL,
   VALIDITY             SMALLINT             NULL DEFAULT NULL,
   HANDLE_OVERDUE       SMALLINT             NULL DEFAULT NULL,
   OVERDUE_REMIND       SMALLINT             NULL DEFAULT NULL,
   VERIFY_CODE_APPEAR   SMALLINT             NULL DEFAULT NULL,
   ERR_LOCK_ACCOUNT     SMALLINT             NULL DEFAULT NULL,
   ENABLE_              SMALLINT             NULL DEFAULT NULL,
   DESC_                TEXT                 NULL,
   CONSTRAINT PK_SYS_PWD_STRATEGY PRIMARY KEY NONCLUSTERED (ID)
)
go
...
CREATE TABLE SYS_LOGIN_LOG (
   ID                   INT                  NOT NULL DEFAULT 0,
   ACCOUNT              VARCHAR(200)         NULL DEFAULT NULL,
