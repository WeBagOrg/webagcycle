...
-- 初始化组织
insert into sys_org (ORGID, DEMID, ORGNAME, ORGDESC, ORGSUPID, PATH, DEPTH, ORGTYPE, CREATORID, CREATETIME, UPDATEID, UPDATETIME, SN,ORGPATHNAME,CODE)
values (2, 1, '广州宏天软件公司', '', 1, '1.2.', 0, 2, 1, '2012-05-03 00:00:00', null, '2012-12-18 00:00:00', 1,'/广州宏天软件公司','A001');

insert into sys_org (ORGID, DEMID, ORGNAME, ORGDESC, ORGSUPID, PATH, DEPTH, ORGTYPE, CREATORID, CREATETIME, UPDATEID, UPDATETIME, SN,ORGPATHNAME,CODE)
values (3, 1, '研发一部', '研发一部', 2, '1.2.3.', 1, 2, 1, '2012-05-03 00:00:00', 1, '2012-12-18 00:00:00', 2,'/广州宏天软件公司/研发一部','A00101')
go

-- 初始化系统默认用户
insert into sys_user (USERID, FULLNAME, ACCOUNT, PASSWORD, ISEXPIRED, ISLOCK, CREATETIME, STATUS, EMAIL, MOBILE, PHONE, SEX, PICTURE)
values (1, '超级管理员', 'admin', 'a4ayc/80/OGda4BO/1o/V0etpOqiLx1JwB5S3beHW0s=', 0, 0, '2012-12-18 00:00:00', 1, 'csx@hotmail.com', '13580000000', '020-61151619', '1', null)
go
...
values (1, 'BPM业务流程系统', 'bpm', '/styles/default/images/logo/bpmx3_logo.jpg', 'http://www.jee-soft.cn', '', '2012-12-15 00:00:00', 'admin', 1, null, 1, 1, '/platform/console/home.ht')
go
...
INSERT INTO bpm_form_dialog VALUES ('10000012450000', '自定义对话框列表', 'zdydhklb', '0', '800', '600', '1', '1', '1', 'bpm_form_dialog', '[{\"field\":\"NAME\",\"comment\":\"对话框名称\"}]', '[{\"field\":\"STYLE\",\"comment\":\"显示样式            0,列表            1,树形\",\"condition\":\"=\",\"dbType\":\"number\",\"defaultType\":\"4\",\"defaultValue\":\"\"}]', '[{\"field\":\"ID\",\"comment\":\"主键ID\"},{\"field\":\"NAME\",\"comment\":\"对话框名称\"}]', '', 'LOCAL', '10', '[]');

INSERT INTO bpm_form_dialog VALUES (10000013140012, '业务数据模板', 'ywsjmb', 0, 800, 600, 1, 1, 0, 'v_formdef_template', '[{\"field\":\"SUBJECT\",\"comment\":\"主题\"}]', '[]', '[{\"field\":\"SUBJECT\",\"comment\":\"主题\"},{\"field\":\"FORMDEFID\",\"comment\":\"表单ID\"},{\"field\":\"CONDITIONFIELD\",\"comment\":\"条件字段\"},{\"field\":\"FORMKEY\",\"comment\":\"表单别名\"}]', '', 'LOCAL', 10, '[]');

INSERT INTO sys_res VALUES (10000013910011, '密码策略', 'mmcl', 1, '//styles/default/images/resicon/documentPack.png', 117, '/platform/system/pwdStrategy/list.ht', 0, 1, 1, 1,  0,'117:10000013910011');
INSERT INTO sys_res VALUES (10000013900007, '用户登录日志', 'yhdlrz', 1, '//styles/default/images/resicon/9.png', 180, '/platform/system/loginLog/list.ht', 0, 1, 1, 1, 0,'');
