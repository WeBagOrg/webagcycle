...
import com.hotent.platform.xml.system.AliasScriptXml;
import com.hotent.platform.xml.system.AliasScriptXmlList;
import com.hotent.platform.xml.system.PersonScriptXml;
...
public class AliasScriptService extends BaseService<AliasScript>
{
	...
	private void importAliasScriptXml(AliasScriptXml aliasScriptXml)
		...
		AliasScript script = this
				.getAliasScriptByName(aliasScript.getId(), map);
