...
public class ResourcesService extends BaseService<Resources>
{
	...
	//ipph add 2015-10-16
	//潘磊新增
	public List<Resources> queryUserIdRoleRes(Map<String,Object> queryFilter){
		  
		List<Resources> resourcesList = this.resourcesDao.getByUserIdResStr(queryFilter);
	    return resourcesList;
	}
	//潘磊新增结束
	
	public int queryDistributeRes(HashMap<String, Object> map) {
		int able = this.resourcesDao.queryDistributeRes(map);
	    return able;
	}

	public int queryTransRes(HashMap<String, Object> map) {
		int able = this.resourcesDao.queryTransRes(map);
	    return able;
	}
}
