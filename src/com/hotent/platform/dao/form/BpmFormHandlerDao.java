...
public class BpmFormHandlerDao {
	...
	public BpmFormData getBussnessDatagetByKey(long tableId, String pkValue, String actDefId, String nodeId,Set<Class> excludeFormat) {
		try {
			 excludeFormatObjects.set(excludeFormat);
			return getByKey(tableId, pkValue, actDefId, nodeId,true);
		} catch (Exception e) {
