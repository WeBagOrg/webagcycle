...
<script type="text/javascript">
	...
	function exportXml(){	
		...
		var url=__ctx + "/platform/form/bpmFormDialog/exportXml.ht?tableIds="+tableIds;
		if (tableIds  ==''){
	...
	//导入自定义对话框
	function importXml(){
		var url=__ctx + "/platform/form/bpmFormDialog/import.ht";
