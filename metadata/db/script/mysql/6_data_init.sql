...
values (1, '超级管理员', 'admin', 'a4ayc/80/OGda4BO/1o/V0etpOqiLx1JwB5S3beHW0s=', 0, 0, str_to_date('01-12-2010','%d-%m-%Y'), 1, 'yg_zhangyg@126.com', '13580000000', '020-61151619', '1', '', 0);
...
values (1, 'BPM业务流程系统', 'bpm', '/styles/default/images/logo/bpmx3_logo.jpg', 'http:/www.jee-soft.cn', '', str_to_date('05-12-2011','%d-%m-%Y'), 'admin', 0, null, 1, 1, '/platform/console/home.ht');
...
values (100, 1, '宏天集团', '广州宏天集团', 1, '1.100.', 0, 1, null, str_to_date('21-01-2013 14:02:02','%d-%m-%Y %H:%i:%s'), null, str_to_date('21-01-2013 14:02:02', '%d-%m-%Y %H:%i:%s'), 100, 0,'/宏天集团','A001');
...
insert into SYS_RES (RESID, RESNAME, ALIAS, SN, ICON,PARENTID, DEFAULTURL, ISFOLDER, ISDISPLAYINMENU, ISOPEN, SYSTEMID,PATH)
values (62, '分级组织管理', 'gradeManager', 8, '/styles/default/images/resicon/s_o_1.png',45, '/platform/system/grade/manage.ht', 0, 1,1, 1, '');
...
insert into SYS_RES (RESID, RESNAME, ALIAS, SN, ICON,PARENTID, DEFAULTURL, ISFOLDER, ISDISPLAYINMENU, ISOPEN, SYSTEMID,PATH)
values (92, '自定义sql查询', 'sqlquery', 8, '/styles/default/images/resicon/o_11.png',81, '/platform/system/sysQuerySqlDef/list.ht', 0, 1,1, 1, '');
...
insert into SYS_RES (RESID, RESNAME, ALIAS, SN, ICON,PARENTID, DEFAULTURL, ISFOLDER, ISDISPLAYINMENU, ISOPEN, SYSTEMID,PATH)
values (141, '常用流程分类统计', 'processTypeCount', 5, '/styles/default/images/resicon/s_f_7.png',137, '/ReportServer?reportlet=ProcessTypeCount_mysql.cpt', 0, 1,1, 1, '');

insert into SYS_RES (RESID, RESNAME, ALIAS, SN, ICON,PARENTID, DEFAULTURL, ISFOLDER, ISDISPLAYINMENU, ISOPEN, SYSTEMID,PATH)
values (142, '常用流程定义统计', 'processDefCount', 6, '/styles/default/images/resicon/s_f_3.png',137, '/ReportServer?reportlet=ProcessDefCount_mysql.cpt', 0, 1,1, 1, '');
...
insert into SYS_RES (RESID, RESNAME, ALIAS, SN, ICON,PARENTID, DEFAULTURL, ISFOLDER, ISDISPLAYINMENU, ISOPEN, SYSTEMID,PATH)
values (188, '数据源信息监控', 'DataSourceInfoMonitor', 2, '/styles/default/images/resicon/i3_14.png',186, '/druid/index.html', 0, 1,1, 1, '');
...
insert into SYS_RES (RESID, RESNAME, ALIAS, SN, ICON,PARENTID, DEFAULTURL, ISFOLDER, ISDISPLAYINMENU, ISOPEN, SYSTEMID,PATH)
values (196, '系统属性', 'xtsx', 1, '//styles/default/images/resicon/s_s_12.png',158, '/platform/system/sysProperty/list.ht', 0, 1,1, 1, '');

insert into SYS_RES (RESID, RESNAME, ALIAS, SN, ICON,PARENTID, DEFAULTURL, ISFOLDER, ISDISPLAYINMENU, ISOPEN, SYSTEMID,PATH)
values (197, '权限批量转移', 'qxplzy', 1, '//styles/default/images/resicon/9.png',117, '/platform/system/sysTransDef/list.ht', 0, 1,1, 1, '');


INSERT INTO sys_res VALUES (202, '栏目公告', 'lmgg', 1, '//styles/default/images/resicon/file.png',1, null, 1, 1, 1, 1, 0, '');

INSERT INTO sys_res VALUES (203, '栏目管理', 'fgslmgl', 1, '//styles/default/images/resicon/file.png', 202, '/platform/system/sysBulletinColumn/list.ht', 1, 1, 1, 1, 0, '202');

INSERT INTO sys_res VALUES (204, '公告管理', 'jtgggl', 1, '//styles/default/images/resicon/icon003a18.gif', 202, '/platform/system/sysBulletin/list.ht', 1, 1, 1, 1, 0, '202');

INSERT INTO sys_res VALUES (205, '公告模板', 'jtggmb', 1, '//styles/default/images/resicon/icon003a18.gif', 202, '/platform/system/sysBulletinTemplate/list.ht', 1, 1, 1, 1, 0, '202');
...
INSERT INTO `sys_index_layout` VALUES (1, '一列(12)', '一列(12)', '<div class=\"col-md-12 column\"></div>', 1);
INSERT INTO `sys_index_layout` VALUES (2, '二列(6,6)', '二列(6,6)', '<div class=\"col-md-6 column\"></div>\r\n<div class=\"col-md-6 column\"></div>', 2);
INSERT INTO `sys_index_layout` VALUES (3, '二列(9,3)', '二列(9,3)', '<div class=\"col-md-9 column\"></div>\r\n<div class=\"col-md-3 column\"></div>', 3);
INSERT INTO `sys_index_layout` VALUES (4, '二列(3,9)', '二列(3,9)', '<div class=\"col-md-3 column\"></div>\r\n<div class=\"col-md-9 column\"></div>', 4);
INSERT INTO `sys_index_layout` VALUES (5, '二列(8,4)', '二列(8,4)', '<div class=\"col-md-8 column\"></div>\r\n<div class=\"col-md-4 column\"></div>', 5);
INSERT INTO `sys_index_layout` VALUES (6, '二列(4,8)', '二列(4,8)', '<div class=\"col-md-4 column\"></div>\r\n<div class=\"col-md-8 column\"></div>', 6);
INSERT INTO `sys_index_layout` VALUES (7, '二列(10,2)', '二列(10,2)', '<div class=\"col-md-10 column\"></div>\r\n<div class=\"col-md-2 column\"></div>', 7);
INSERT INTO `sys_index_layout` VALUES (8, '二列(2,10)', '二列(2,10)', '<div class=\"col-md-2 column\"></div>\r\n<div class=\"col-md-10 column\"></div>', 8);
INSERT INTO `sys_index_layout` VALUES (9, '三列(4,4,4)', '二列(4,4,4)', '<div class=\"col-md-4 column\"></div>\r\n<div class=\"col-md-4 column\"></div>\r\n<div class=\"col-md-4 column\"></div>', 9);
INSERT INTO `sys_index_layout` VALUES (10, '三列(2,6,4)', '二列(2,6,4)', '<div class=\"col-md-2 column\"></div>\r\n<div class=\"col-md-6 column\"></div>\r\n<div class=\"col-md-4 column\"></div>', 10);
INSERT INTO `sys_index_layout` VALUES (11, '三列(4,6,2)', '二列(4,6,2)', '<div class=\"col-md-4 column\"></div>\r\n<div class=\"col-md-6 column\"></div>\r\n<div class=\"col-md-2 column\"></div>', 11);
...
insert into SYS_PROPERTY (id,NAME_,ALIAS_,VALUE_,GROUP_,SN_,memo) 
values(15,'BPM_BUS_LINK分区是否支持分区','supportPartion','0','系统参数',15,'是否支持数据库表BPM_BUS_LINK分区 0=不分区,1分区');
...
insert into SYS_PROPERTY (id,NAME_,ALIAS_,VALUE_,GROUP_,SN_,memo) 
values(26,'日期类型','datatype.date','date,timestamp,datetime','数据类型',28,'数据类型');
...
INSERT INTO bpm_form_dialog VALUES (1, '自定义对话框列表', 'zdydhklb', '0', '800', '600', '1', '1', '1', 'bpm_form_dialog', '[{\"field\":\"NAME\",\"comment\":\"对话框名称\"}]', '[{\"field\":\"STYLE\",\"comment\":\"显示样式            0,列表            1,树形\",\"condition\":\"=\",\"dbType\":\"number\",\"defaultType\":\"4\",\"defaultValue\":\"\"}]', '[{\"field\":\"ID\",\"comment\":\"主键ID\"},{\"field\":\"NAME\",\"comment\":\"对话框名称\"}]', '', 'LOCAL', '10', '[]');

INSERT INTO bpm_form_dialog VALUES (2, '业务数据模板', 'ywsjmb', 0, 800, 600, 1, 1, 0, 'v_formdef_template', '[{\"field\":\"SUBJECT\",\"comment\":\"主题\"}]', '[]', '[{\"field\":\"SUBJECT\",\"comment\":\"主题\"},{\"field\":\"FORMDEFID\",\"comment\":\"表单ID\"},{\"field\":\"CONDITIONFIELD\",\"comment\":\"条件字段\"},{\"field\":\"FORMKEY\",\"comment\":\"表单别名\"}]', '', 'LOCAL', 10, '[]');

create view v_formdef_template as (select b.SUBJECT AS SUBJECT,b.FORMDEFID AS FORMDEFID,a.CONDITIONFIELD AS CONDITIONFIELD,b.FORMKEY AS FORMKEY from (bpm_data_template a join bpm_form_def b) where ((a.FORMKEY = b.FORMKEY) and (b.ISDEFAULT = 1)));


INSERT INTO sys_res VALUES (300, '首页管理', 'SysIndexManage', 1, '//styles/default/images/resicon/1_open.png', 122, NULL, 1, 1, 1, 1, 0, '');
INSERT INTO sys_res VALUES (301, '首页栏目', 'SysIndexColumn', 1, '//styles/default/images/resicon/columnTemplate.gif', 300, '/platform/system/sysIndexColumn/list.ht', 0, 1, 1, 1, 0, '');
INSERT INTO sys_res VALUES (302, '首页布局', 'SysIndexLayout', 1, '//styles/default/images/resicon/settingOld.png', 300, '/platform/system/sysIndexLayout/list.ht', 0, 1, 1, 1, 0, '');
INSERT INTO sys_res VALUES (303, '布局管理', 'SysIndexLayoutManage', 1, '//styles/default/images/resicon/i3_7.png', 300, '/platform/system/sysIndexLayoutManage/list.ht', 0, 1, 1, 1, 0, '');
INSERT INTO sys_res VALUES (304, '我的首页布局', 'sysIndexMyLayout', 1, '//styles/default/images/resicon/s_o_1.png', 300, '/platform/system/sysIndexMyLayout/design.ht', 0, 1, 1, 1, 0, '');
	
INSERT INTO sys_res VALUES (305, '密码策略', 'mmcl', 1, '//styles/default/images/resicon/documentPack.png', 117, '/platform/system/pwdStrategy/list.ht', 0, 1, 1, 1, 0,'117:305');
INSERT INTO sys_res VALUES (306, '用户登录日志', 'yhdlrz', 1, '//styles/default/images/resicon/9.png', 180, '/platform/system/loginLog/list.ht', 0, 1, 1, 1, 0,'');
INSERT INTO sys_res VALUES(307,'流程批量审批定义设置管理','lcplspdyszgl','10'	,'//styles/default/images/resicon/icon_tab2.png','99','/platform/bpm/bpmBatchApproval/list.ht',0,1,1,1,0,'');
INSERT INTO sys_res VALUES (308,'word套打','wordtd',1,'//styles/default/images/resicon/i3_1.png',81,'/platform/system/sysWordTemplate/list.ht','0','1','1','1','0','');


INSERT INTO sys_identity VALUES (1, 'globalFlowNo', 'globalFlowNo', '{yyyy}{MM}{dd}{NO}', '2', '5', '2015714', '1', '25', '1');

INSERT INTO SYS_TRANS_DEF VALUES (1, '流程待办_执行人', 'return "select a.ID_ id,b.SUBJECT name,a.ID_ 主键 ,b. SUBJECT 名称 from act_ru_task a,bpm_pro_run b where a.ASSIGNEE_={authorId} and b.ACTINSTID=a.PROC_INST_ID_";', 'return "update act_ru_task t set ASSIGNEE_ ={targetPersonId} where t.ID_ in ({ids})";', '1', '1', 'admin','2015-05-09 00:00:00', '{authorName} 把其为执行人的流程待办 {names} 转移给了 {targetPersonName};');
INSERT INTO SYS_TRANS_DEF VALUES (2, '代理配置_授权人', 'return "select a.ID id,a.AGENT name,a.ID 主键,a.AGENT 代理人 from bpm_agent_setting a where a.AUTHID={authorId};";', 'return "update bpm_agent_setting a set a.AUTHID={targetPersonId} , a.AUTHNAME=''{targetPersonName}'' where a.ID in({ids});";', '1', '1', 'admin', '2015-05-09 00:00:00', '{authorName} 把他代理给 {names} 的 代理配置 转移给了 {targetPersonName}');
INSERT INTO SYS_TRANS_DEF VALUES (3, '代理配置_代理人', 'return "select t.ID id,t.authName name, t.ID 主键,t.authName 授权人 from bpm_agent_setting t where t.AGENTID={authorId}";', 'return "update bpm_agent_setting t set t.AGENTID={targetPersonId},t.AGENT=''{targetPersonName}''  where t.ID in ({ids})";', '1', '1', 'admin', '2015-05-09 00:00:00', '{authorName} 把授权人为 {names} 的代理给他的代理配置 转移给了 {targetPersonName}');
INSERT INTO SYS_TRANS_DEF VALUES (4, '角色转移', 'return "select a.USERROLEID id,c.SYSNAME || '':'' ||b.roleName name,a.USERROLEID 主键,c.SYSNAME 系统名称,b.ROLENAME 角色名称 from SYS_USER_ROLE a,SYS_ROLE b left join sys_subsystem c on b.systemid=c.systemid where a.roleid=b.roleId    and  userId={authorId}";', 'return "update sys_user_role a set a.USERID=''{targetPersonId}'' where a.USERROLEID in({ids})";', '1', '1', 'admin', '2015-05-09 00:00:00', '{authorName} 把角色信息为 {names} 转移给了 {targetPersonName}');
INSERT INTO SYS_TRANS_DEF VALUES (5, '办结流程', 'return "select distinct run.RUNID id,run.SUBJECT name,run.RUNID 主键,run.SUBJECT 名称 from BPM_PRO_RUN_HIS run where run.creatorid=''{authorId}'' and (run.status = 2 or  run.status = 3) ";', 'return "update bpm_pro_run_his run set run.CREATORID=''{targetPersonId}'' ,run.CREATOR=''{targetPersonName}'' where run.RUNID in ({ids})";', '1', '1', 'admin', '2015-05-09 00:00:00', '{authorName} 把办结流程 {names} 转移给 {targetPersonName}');
INSERT INTO SYS_TRANS_DEF VALUES (6, '流程待办_候选人', 'return "select ident.ID_ id,run.SUBJECT name, ident.ID_ 主键,run.SUBJECT 名称 from act_ru_task task,act_ru_identitylink ident,bpm_pro_run run where task.id_ = ident.TASK_ID_ and run.ACTINSTID=task.PROC_INST_ID_ and task.ASSIGNEE_=0 and ident.USER_ID_={authorId}";', 'return "update act_ru_identitylink ident set ident.USER_ID_={targetPersonId} where ident.ID_ in ({ids})";', '1', '1', 'admin', '2015-05-09 00:00:00', '{authorName} 把其为候选人的流程待办 {names} 转移给了 {targetPersonName};');
INSERT INTO SYS_TRANS_DEF VALUES (7, '流程节点人员', 'return "select a.NODEUSERID id,c.SUBJECT || ''-'' || d.NODENAME name,a.NODEUSERID 主键,c.SUBJECT 流程标题,d.NODENAME 节点名称 from bpm_node_user a,bpm_user_condition b,bpm_definition c,bpm_node_set d where a.CONDITIONID=b.ID and b.ACTDEFID=c.ACTDEFID and b.SETID=d.SETID and a.ASSIGNTYPE=''users'' and  dbms_lob.instr(CMPIDS, ''{authorId}'', 1, 1)>0";', 'import com.hotent.core.util.AppUtil;
import org.springframework.jdbc.core.JdbcTemplate;
  
  JdbcTemplate jdbcTemplate = AppUtil.getBean(JdbcTemplate.class);
  String[] ids = "{ids}".split(",");
  for(String id:ids){
     String sql="select a.CMPIDS,a.CMPNAMES from bpm_node_user a where a.NODEUSERID="+id; 
    ...
    for(String cmpId:(map.get("CMPIDS")+"").split(",")){
        if(cmpId.equals("{authorId}")){
          cmpId="{targetPersonId}";
        }
        if(cmpIds.length()>0){
           cmpIds+=","; 
         }
    ...
    for(String cmpName:(map.get("CMPNAMES")+"").split(",")){
        if(cmpName.equals("{authorName}")){
          cmpName="{targetPersonName}";
        }
     ...
     sql="update bpm_node_user a set a.CMPIDS=''"+cmpIds+"'' ,a.CMPNAMES=''"+cmpNames+"'' where a.NODEUSERID="+id;    
        
     jdbcTemplate.execute(sql);
   }
  return "";', '1', '1', 'admin', '2015-05-09 00:00:00', '{authorName} 把流程节点设置 {names} 转移给了 {targetPersonName}');
