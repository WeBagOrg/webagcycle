...
<body>
	<div id="defLayout">
							...
							<td>
								<select id="selectRefer"  style="min-width: 100px">
									...
									<c:forEach items="${refers}" var="refer">
										<option value="${refer.referDefKey}">${refer.subject}</option>
									</c:forEach>
								</select>
							</td>
						</tr>
			...
			<div position="bottom"  class="bottom" style="height:30px;" >
				<a href="javascript:;" id="btnSelect" class="button" onclick="selectInst()" style="margin-right:10px;" ><span class="icon ok"></span><span class="chosen">选择</span></a>
				<a href="javascript:;" class="button"  onclick="clearInst()"><span class="icon cancel" ></span><span class="chosen" >清空</span></a>
