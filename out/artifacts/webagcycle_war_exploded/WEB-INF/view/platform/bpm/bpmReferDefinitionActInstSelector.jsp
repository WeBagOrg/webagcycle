			...
			<div class="panel-body">
				...
				<display:table name="processRunList" id="processRunItem" requestURI="actInstSelector.ht" sort="external" cellpadding="1"
					...
					<display:column title="请求标题" sortable="true" sortName="subject" style="text-align:left">
						<a name="processDetail" onclick="showDetail(this)" href="javascript:;"  action="${ctx}/platform/bpm/processRun/info.ht?link=1&runId=${processRunItem.runId}" title="${processRunItem.subject}">${f:subString(processRunItem.subject)}</a>
					</display:column>
