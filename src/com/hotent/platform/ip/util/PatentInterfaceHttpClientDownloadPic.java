 ...
 *
 */
public class PatentInterfaceHttpClientDownloadPic{
	private String webAddress = "";  
    private String destFile = "";  
    public PatentInterfaceHttpClientDownloadPic(){  
    } 
    public PatentInterfaceHttpClientDownloadPic(String address){
