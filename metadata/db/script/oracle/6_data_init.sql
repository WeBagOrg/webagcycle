...
INSERT INTO sys_res VALUES (306, '密码策略', 'mmcl', 1, '//styles/default/images/resicon/documentPack.png', 117, '/platform/system/pwdStrategy/list.ht', 0, 1, 1, 1, 0,'117:306');
INSERT INTO sys_res VALUES (307, '用户登录日志', 'yhdlrz', 1, '//styles/default/images/resicon/9.png', 180, '/platform/system/loginLog/list.ht', 0, 1, 1, 1, 0,'');
INSERT INTO sys_res VALUES(308,'流程批量审批定义设置管理','lcplspdyszgl','10'	,'//styles/default/images/resicon/icon_tab2.png','99','/platform/bpm/bpmBatchApproval/list.ht',0,1,1,1,0,'');
...
create view v_formdef_template (SUBJECT,FORMDEFID,CONDITIONFIELD,FORMKEY) as (select b.SUBJECT AS SUBJECT,b.FORMDEFID AS FORMDEFID,a.CONDITIONFIELD AS CONDITIONFIELD,b.FORMKEY AS FORMKEY from bpm_data_template a , bpm_form_def b where (a.FORMKEY = b.FORMKEY and b.ISDEFAULT = 1));
...
import org.springframework.jdbc.core.JdbcTemplate;
  ...
  return "";', '1', '1', 'admin', TO_DATE('2015-05-09 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '{authorName} 把流程节点设置 {names} 转移给了 {targetPersonName}');
