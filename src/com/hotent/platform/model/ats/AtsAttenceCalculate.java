...
public class AtsAttenceCalculate extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.id, rhs.id)
				...
				.append(this.tripRecord, rhs.tripRecord).isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.id)
				...
				.append(this.actualAttenceHours).append(this.cardRecord)
				.append(this.absentNumber).append(this.absentTime)
				.append(this.absentRecord).append(this.lateNumber)
				.append(this.lateTime).append(this.lateRecord)
				.append(this.leaveNumber).append(this.leaveTime)
				.append(this.leaveRecord).append(this.otNumber)
				.append(this.otTime).append(this.otRecord)
				.append(this.holidayNumber).append(this.holidayTime)
				.append(this.holidayUnit).append(this.holidayRecord)
				.append(this.tripNumber).append(this.tripTime)
				.append(this.tripRecord).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id)
				...
				.append("tripRecord", this.tripRecord).toString();
	}
