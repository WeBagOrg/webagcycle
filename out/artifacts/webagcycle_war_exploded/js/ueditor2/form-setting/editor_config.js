...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:reviseURL+"imageShow.jsp"                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imageFieldName:"oriFileName"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
             ...
             'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|','searchreplace','insertimage'
                ]
        ]
