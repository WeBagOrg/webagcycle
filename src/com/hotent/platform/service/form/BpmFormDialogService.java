...
import com.hotent.platform.xml.system.SysQuerySqlDefXml;
import com.hotent.platform.xml.system.SysQuerySqlDefXmlList;
...
public class BpmFormDialogService extends BaseService<BpmFormDialog> {
	 ...
	 * @throws Exception
	 */
	public List<Map<String, Object>> getTreeData(String alias, Map<String, Object> params, boolean isRoot) throws Exception {
		BpmFormDialog bpmFormDialog = dao.getByAlias(alias);
		/*DbContextHolder.setDataSource(bpmFormDialog.getDsalias());*/
		...
		List<Map<String, Object>> list = JdbcTemplateUtil.getNamedParameterJdbcTemplate(template).queryForList(sql, params);
		return list;
	}
