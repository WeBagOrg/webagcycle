...
public class BpmNodeSetDao extends BaseDao<BpmNodeSet>
{
	...
	public List<BpmNodeSet> getByDefIdOpinion(Long defId){
		return this.getBySqlKey("getByDefIdOpinion", defId);
	}

	
	public List<BpmNodeSet> getByParentDefIdOpinion(Long defId,String parentActDefId){
		Map<String,Object> params=new HashMap<String,Object>();
		params.put("defId", defId);
		params.put("parentActDefId", parentActDefId);
		
		return this.getBySqlKey("getByParentDefIdOpinion", params);
	}
}