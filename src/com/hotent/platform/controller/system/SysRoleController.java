...
public class SysRoleController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		SysUser current_user=(SysUser) ContextUtil.getCurrentUser();
		boolean isAdmin =current_user.getAccount().equals(SysUser.getAdminAccount());
		List<String> categoryList = sysRoleService.getDistinctCategory();
		mv.addObject("isAdmin", isAdmin).addObject("categoryList", categoryList);
		return mv;
	}
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception {
		...
		List<String> categoryList = sysRoleService.getDistinctCategory();
		return getAutoView().addObject("sysRole", sysRole).addObject("subsystemList", list).addObject("returnUrl", returnUrl).addObject("categoryList", categoryList);
	}
