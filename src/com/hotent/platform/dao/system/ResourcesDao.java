...
public class ResourcesDao extends BaseDao<Resources>
{
	...
	//ipph add 2015-10-16
	//潘磊新增
	public List<Resources> getByUserIdResStr(Map<String,Object> queryFilter){
	    return getBySqlKey("getByUserIdResStr", queryFilter);
	}
	
	//分配专利工程师的权限
	public int queryDistributeRes(HashMap<String, Object> map) {
		 return (Integer)getOne("queryDistributeRes", map);
	}

	public int queryTransRes(HashMap<String, Object> map) {
		 return (Integer)getOne("queryTransRes", map);
	}
}