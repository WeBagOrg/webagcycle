...
public class SysQueryViewService extends  BaseService<SysQueryView>
{
	...
	public PageList getPageList(int currentPage,int pageSize,Map<String,Object> params,
			SysQueryView sysQueryView,String sortField,String sortSeq) throws Exception{
	...
	private void handRow(Map row,Map<String,SysQueryMetaField> fieldMap,Map<String,Map<String,String>>  valMap,JdbcTemplate jdbcTemplate){
		...
		for (Object obj : row.keySet()) {
			...
			if(field != null && field.getDataType() != null && 
					ColumnModel.COLUMNTYPE_DATE.equalsIgnoreCase( field.getDataType())){
	 ...
	 * @throws Exception
	 */
	public HSSFWorkbook genExcel(int  currentPage,int pageSize,
			Map queryParams,SysQueryView sysQueryView,String sortField,String orderSeq,String exportFields) throws Exception{
