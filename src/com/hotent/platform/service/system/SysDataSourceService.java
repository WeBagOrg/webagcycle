...
import com.hotent.platform.xml.system.PersonScriptXmlList;
import com.hotent.platform.xml.system.SysDataSourceXml;
import com.hotent.platform.xml.system.SysDataSourceXmlList;
...
public class SysDataSourceService extends BaseService<SysDataSource> implements ISysDataSourceService {
	 ...
	 * @throws Exception
	 */
	public String exportXml(List<SysDataSource> sysDataSources)
			throws Exception {
		...
		for (SysDataSource sysDataSource : sysDataSources) {
			SysDataSourceXml sysDataSourceXml = this
					.exportsysDataSource(sysDataSource);
