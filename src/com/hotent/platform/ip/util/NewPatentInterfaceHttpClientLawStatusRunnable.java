 ...
 *
 */
public class NewPatentInterfaceHttpClientLawStatusRunnable implements Runnable{
	...
	public NewPatentInterfaceHttpClientLawStatusRunnable(){
		
	}
	public NewPatentInterfaceHttpClientLawStatusRunnable(String appNumber,Date lawDate){
		this.appNumber=appNumber;
		this.lawDate=lawDate;
	}
	public NewPatentInterfaceHttpClientLawStatusRunnable(String[] appNumbers,Date[] lawDates){
		this.appNumbers=appNumbers;
		this.lawDates=lawDates;
	}
	@Override
