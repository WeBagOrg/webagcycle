...
<script type="text/javascript">
	...
	function exportXml(){	
		...
		ImportExportXml.showModalDialog({url:url,height:450,title:'导出流程定义'});
	}
...
<body>      
	...
	<div class="panel-top">	
		...
		<div class="panel-body">
			    ...
			    <display:table name="bpmDefinitionList" id="bpmDefinitionItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid except ">
					...
					<display:column property="defKey" title="FlowKey" sortable="true" sortName="subject"  style="width:90px;"></display:column>
