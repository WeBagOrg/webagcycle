...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:reviseURL                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,filePath:reviseURL                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"jsp/getRemoteImage.jsp"   //处理远程图片抓取的地址
        ,catcherPath:reviseURL                  //图片修正地址，同imagePath
        ...
        ,imageManagerPath:reviseURL                                    //图片修正地址，同imagePath
        ...
        ,toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                ...
                'formatmatch','blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist',
                ...
                'insertframe','pagebreak', '|','horizontal', 'spechars', '|','inserttable', 'deletetable', 
                'insertparagraphbeforetable', 'insertrow','insertrownext', 'deleterow', 'insertcol','insertcolnext', 'deletecol', 'mergecells', 
                'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|','searchreplace',
                ...
                'myeditor','rolepicker','positionpicker','attachement','websigncontrol','importform','exportform',
                '|','pasteinput','tableformat','choosetemplate','opinion','input','wordtemplate','|','taskopinion','flowchart',
                'insertfunction','cutsubtable','pastesubtable','customquery','uncustomquery','daterangevalidate','datecalculate','pictureshowcontrol','processinstance','help']
        ]
        ...
        ,iframeCssUrl: __ctx +"/styles/default/css/form.css" //给编辑器内部引入一个css文件
