...
public class BpmFormDialogController extends BaseController {
	...
	@ResponseBody
	public List<Map<String, Object>> getTreeData(HttpServletRequest request) throws Exception {
...
//		DbContextHolder.setDataSource(bpmFormDialog.getDsalias()); 
		...
		if(null!=bpmFormDialog&&isSingle!=0){
			bpmFormDialog.setIssingle(isSingle);
		}
