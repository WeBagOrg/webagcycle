		...
		<div class="panel" id="taskLayout" type="layout" >
			<div  position="center" >
						...
						<div class="panel-search" style="margin-left:25px;float:left">
							<form id="searchForm" method="post" action="list.ht" style="display:block;">
								<ul class="row">
									...
									<li><span class="label">执行人:</span><input type="text" name="Q_assignee__SL"  class="inputText"  value="${param['Q_assignee__SL']}"/></li>
								</ul>
							</form>
						</div>	
				</div>	
					<div class="panel-body" >
					    ...
					    <display:table name="taskList" id="taskItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"    class="table-grid except" export="true" >
